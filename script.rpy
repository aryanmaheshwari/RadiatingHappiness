...
define DaVie = Character("DaVie")
define Jellie = Character("Jellie")
define Ari = Character("Ari")
...
label start:
    ...
    Headmaster "Welcome to Cupid University, a campus of acceptance and excitement. I’m honored that you all have chosen our prestigious school as your college of choice. I hope your first year will treat you well and you will enjoy your time with us. Now, off you go!"
...
label week1:
    scene bg room
    Headmaster "It’s finally move-in day! Although it’ll be hard living far from home, the exciting experiences at the form are waiting for you!"
...
label past_connection_convo:
    Jellie "Don't you remember me, we used to hang out all the time!"
    menu:
