label start_ari_date:
    ...
    menu:
        ...
        "Yeah.. thank you Jellie, that cleared up a lot. I think I'm going to try going to the date.":
            hide jellie normal
            jump continue_date_ari
label continue_date_ari:
    Narrator "You decide to reply to Ari through a text with an equally excited response. Which soon becomes hearted by the blushing boy."
    ...
    menu:
        "OMG I love ice skating! I’ll have you know I’m a pro":
            show ari happy
            Ari "Ohoho, I'll have to have you help me not fall then "
            Main "Sounds like a plan haha!"
            Narrator "True to his word, Ari was complete chaos on the ice. The amount of time he fell on his butt was hilarious"
            Ari "You're having too much fun with this, do you enjoy having me fall for you that much?"
            jump common_end_ari_date
        "OMG I love ice skating! I’m not that good at it though":
            show ari happy
            Ari "That's alright, I'll be there to prevent you from falling ;)"
            Main "okayyy I'll believe you"
            Narrator "True to your word, you were complete chaos on the ice. The amount of times you almost fell was hilarious"
            Ari "I'm sorry for laughing, I just can't believe you were actually this bad, do you enjoy falling for me that much?"
            jump common_end_ari_date

label common_end_ari_date:
    Narrator "With him, it was easy. The banter flowed between the two and laughter was plenty.
At one point, you began to fall again only for him to steady you in his arms. "
